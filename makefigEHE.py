...
plt.figure(3,  figsize=(4, 2.5), dpi=100, facecolor='w', edgecolor='k')
...
for (num, droot) in enumerate(dirz):
    ...
    ax.set_title('Easy-Hard-Easy transition')
...
plt.axvline(200, linestyle='--', c='k')
plt.text(40, 30, 'Easy')
plt.text(140, 30, 'Hard')
plt.text(240, 30, 'Easy')
...
plt.savefig('figEHE.png', bbox_inches='tight')
